...
RSpec.describe Invoice, type: :model do
  before(:each) do 
    ...
    @coupon_1 = create(:coupon, merchant: @merchant1, status: 1, discount: 50, discount_type: 1) #100.00 total revenue, #$50.00 grand total
  ...
  describe "instance methods" do
    ...
    it '#grand_total(dollars off)' do 
      ...
      expect(@invoice_1.grand_total).to eq(50.00)
    end
    
    it '#grand_total(percentage off)' do 
      expect(@invoice_1.grand_total).to eq(5.00)
    end
  end
end
